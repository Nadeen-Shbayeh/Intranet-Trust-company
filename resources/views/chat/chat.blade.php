...
<head>
  ...
  <!-- Custom styles -->
  <link rel="stylesheet" href="resources/css/fontawesome/css/fontawesome.min.css">
                                ...
                                <div class="chat-list-wrapper" style="overflow-y: auto; width: auto; height: 550px;">
                                    <ul class="chat-list">
                                      @foreach($users as $user)
                                          ...
                                          <li class="new">
                                              <span class="avatar">
                                                  <img src="{{ url('storage/img/'. $user->file)      }}" alt="avatar" class="img-circle">
                                              </span>
                                              <div class="body">
                                                  <div class="header">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="recipient-box"> 
                                <select data-placeholder=" " class="form-control chzn-select chzn-done" multiple="" style="display: none;"> 
                                    <option>Kevin Mckoy</option>
                                    <option value="y.robinson@ztapps.com" selected="">Yanique Robinson</option>
                                    <option value="gavino@ztapps.com">eswt54ytryhtre</option> 
